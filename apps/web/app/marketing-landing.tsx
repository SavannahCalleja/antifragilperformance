      ...
      <main className="flex w-full flex-1 flex-col">
                ...
                <div className="relative z-10 flex max-w-[17rem] flex-col items-center gap-3 px-4 text-center sm:max-w-[22rem] sm:gap-3.5 md:max-w-[26rem]">
                  ...
                  {signedIn ? (
                    <div className="mt-8 flex w-full max-w-xs flex-col items-center gap-4">
                      <p className="text-center text-sm text-[#E5E4E2]/70">
                        Signed in
                        {userEmail ? (
                          <>
                            <br />
                            <span className="text-[#E5E4E2]/90">{userEmail}</span>
                          </>
                        ) : null}
                      </p>
                      <button
                        ...
                        className="btn-join min-h-12 w-full rounded-md px-8 text-sm font-semibold uppercase tracking-wide"
                      >
                        Sign out
                      </button>
                    </div>
                    ...
                    <div className="mt-10 flex w-full max-w-sm flex-col gap-3 sm:flex-row sm:justify-center">
                      <button
                        type="button"
                        onClick={onLogin}
                        className="btn-join min-h-12 flex-1 rounded-md px-6 text-sm font-semibold uppercase tracking-wide"
                      >
                        Login
                      </button>
                      <button
                        type="button"
                        onClick={onSignup}
                        className="min-h-12 flex-1 rounded-md border-2 border-[#FF69B4] bg-transparent px-6 text-sm font-semibold uppercase tracking-wide text-[#FF69B4] transition-colors hover:bg-[#FF69B4]/10"
                      >
                        Create Account
                      </button>
                    </div>
        ...
        >
          <div className="mx-auto w-full max-w-6xl">
            ...
            {signedIn ? (
              <div className="mx-auto mt-16 max-w-lg text-center md:mt-20">
                <p className="text-sm leading-relaxed text-[#E5E4E2]/72">
                  You’re signed in. Training tools live in the mobile Command Center.
                </p>
              </div>
            ) : null}
          </div>
